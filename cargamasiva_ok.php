	...
	foreach ($lineas as $linea_num => $linea) {
		if ($i != 0) {
			...
			if ($num == 0) { // INSERT
		   		...
		   		$sql = "INSERT INTO relacion_cliente_juicio (NUM_JUICIO, ID_CLIENTE, CECRTID, CEDOSSIERID, CETYPE, nombre) VALUES (".$numjuicio.",".$rutcliente.",'".$tribunal."','".$rol."','".$tipojuicio."','".$nombre."')";
		   		call_insert($sql,"");
				...
				$sql = "UPDATE relacion_cliente_juicio SET CECRTID='".$tribunal."', CETYPE='".$tipojuicio."', nombre='".$nombre."', CEDOSSIERID='".$rol."' WHERE (NUM_JUICIO='".$numjuicio."') AND (ID_CLIENTE='".$rutcliente."') ";
				call_update($sql);
			...
			$stg_id = 1; // Identificador de la etapa
