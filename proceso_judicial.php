						...
						<div class="card-block">
							...
							<div class="row">
								<div class="form-group col-sm-4" col>
									<label>Rut</label>
									<input type="text" placeholder="0181740639" class="form-control" id="idCliente" width="70px" tabindex="1" name="idCliente" onkeyup="mostrar_idCliente('controlador/script_info_juicios.php?idCliente='+document.form.idCliente.value+'&opcion=4',document.form.idCliente.value);" onKeyPress="return solonum_Rut(event);">
								...
								<div class="form-group col-sm-3">
									...
									<label>Juzgado</label>
									<input type="text" placeholder="1JUZLARI" class="form-control" id="idJuzgado" width="70px" tabindex="1" name="idJuzgado" onkeyup="mostrar_juzgados('controlador/script_info_juicios.php?idJuzgado='+document.form.idJuzgado.value+'&opcion=2',document.form.idJuzgado.value);" readonly>
									<div id="juzgados"></div>
						...
						<div class="card-block">
							...
							<div class="row">
								<div id="codigoResultado" class="form-group col-sm-6">
									...
									<select class="form-control" id="codR" name="">
								...
								<div class="form-group col-sm-6">
									...
									<!-- <input type="text" class="form-control" id="comen" onkeyup="mostrar_comentarios('controlador/script_200_gestion.php?desCodA='+document.form.comen.value+'&opcion=1a',document.form.comen.value);" placeholder="Comentario"> -->
									<!-- <div id="codigo_comentario"></div> -->

									<select class="form-control" id="comen" name="comen">
										<option value="defecto"><b>Seleccione Comentario</b></option>
										<?php
										$sql_consulta = "SELECT COMENTARIO FROM comentario_gestion ORDER BY COMENTARIO";
										$datosFechas = array();
										$datosFechas = call_select($sql_consulta, "");
										while ($resultFechas = mysql_fetch_array($datosFechas['registros'])) {
											echo "<option value='" .$resultFechas['COMENTARIO']. "' >" .$resultFechas['COMENTARIO']. "</option>";
										}
										?>
									</select>
...
<script>
	$(document).ready(function() {
		$("#fechaInicio, #fechaFin, #fecha, #fechaAuto").datepicker({
			weekStart: 1,
			changeMonth: true,
			changeYear: true,
			dateFormat: 'dd/mm/yy',
